#ifndef ADVENT_OF_CODE_BACK_INSERT_SORT_ITERATOR_HPP
#define ADVENT_OF_CODE_BACK_INSERT_SORT_ITERATOR_HPP
...
#endif //ADVENT_OF_CODE_BACK_INSERT_SORT_ITERATOR_HPP